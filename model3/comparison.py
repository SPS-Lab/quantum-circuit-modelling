...
def compare_model1_model2_against_scqubits(
    ...
    *,
    ...
    axParams.set_ylabel(r"Exchange $J$ (GHz)")
    axParams.set_title(r"Extracted $J$")
    axParams.grid(True, alpha=0.3)
    axParams.legend(loc="best", fontsize="small")

    axRegime.plot(flux_values, p3["zeta"], color="C2", linewidth=1.8, label=r"scqubits $\zeta$")
    axRegime.plot(flux_values, p2["zeta"], color="C2", linestyle="--", linewidth=1.4, label=r"model2 $\zeta$")
    axRegime.plot(flux_values, p1["zeta"], color="C2", linestyle=":", linewidth=1.4, label=r"model1 $\zeta$")
    axRegime.axhline(0.0, color="0.35", linestyle=":", linewidth=1.0)
    axRegime.set_ylabel(r"Residual ZZ $\zeta$ (GHz)")
    axRegime.set_title(r"Extracted $\zeta$")
