...
def test_load_study_config(tmp_path: Path) -> None:
    ...
    assert len(cfg.circuit_truncation_benchmark.circuit_truncation_values) > 0
    ...
    assert len(cfg.duffing_truncation_benchmark.duffing_hilbert_truncation_values) > 0
